...
function InformationConversation() {
  ...
  return (
    <>
      <div className='mx-auto h-screen max-w-2xl bg-mainBlue'>
        <div className='flex flex-col items-center pb-10'>
          ...
          <div>
            <ul className='mx-2 hidden flex-col overflow-x-hidden rounded-lg bg-white px-6 py-2 font-semibold md:flex'>
